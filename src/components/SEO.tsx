...
const websiteSchema = {
  ...
  "potentialAction": {
    "@type": "SearchAction",
    "target": "https://himsols.online/blog?search={search_term_string}",
...
export const SEO = ({
  ...
  description = "Himsols is a tree plantation implementation partner in Himachal Pradesh — we plant native trees, geo-tag them and track survival. Free for farmers.",
...
export const BlogPostSchema = ({ 
  ...
  useEffect(() => {
    const articleSchema = {
      ...
      "image": image || "https://himsols.online/pwa-512x512.png",
      "url": url,
      ...
      "publisher": {
        ...
        "logo": {
          "@type": "ImageObject",
          "url": "https://himsols.online/favicon.png"
        }
      },
