...
export const SUSTAINABILITY_DAYS: SustainabilityDay[] = [
  {
    ...
    howToCelebrate: [
      ...
      "Contribute to an active campaign and watch the live tree-count grow in real time.",
  ...
  },
  {
    ...
    faqs: [
      ...
      { q: "Is Earth Day plantation tax deductible in India?", a: "Contributions to registered Himsols campaigns may qualify for 80G tax exemption. Contact our team for the latest eligibility and corporate CSR documentation." },
    ],
  ...
  },
  {
    ...
    howToCelebrate: [
      ...
      "Contribute to a conservation-focused campaign.",
