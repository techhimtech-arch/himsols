...
export interface HPCity {
  ...
  altitudeM: number;
  knownFor: string;
  localAngle: string; // 2-3 sentences — why plantation matters here specifically
  nativeSpecies: string[]; // species suited to this region
...
export const HP_CITIES: HPCity[] = [
  {
    ...
    localAngle:
      "Shimla's deodar belt has been thinning rapidly due to construction pressure, landslides and unmanaged tourism. Planting native deodar, oak and rhododendron on verified farmer land in surrounding villages like Kufri, Mashobra and Theog directly stabilises the hills that the city sits on.",
  ...
  },
  {
    ...
    localAngle:
      "Manali and the upper Beas valley have lost significant tree cover to road expansion, hotels and the 2023 floods. Plantation in surrounding villages like Naggar, Jagatsukh and Burwa reinforces fragile slopes and protects apple farmer livelihoods downstream.",
    nativeSpecies: ["Deodar", "Blue Pine", "Apple", "Walnut", "Horse Chestnut"],
    faqs: [
      { q: "How can tourists offset their Manali trip carbon?", a: "Sponsor one Himsols tree (₹299) per traveller — it offsets roughly 22 kg of CO₂ per year for the next 30+ years and is planted in the Kullu-Manali region itself." },
  ...
  },
  {
    ...
    localAngle:
      "The Dhauladhar foothills around Dharamshala have seen aggressive deforestation for construction. Planting oak and pine on Kangra valley farmer land restores the catchment that feeds the entire region's springs and streams.",
  ...
  },
  {
    ...
    localAngle:
      "Kullu valley supports thousands of small apple and walnut farmers whose income is directly tied to forest health and water availability. Himsols' verified plantation across Kullu villages keeps farmers on the land instead of migrating to cities.",
  ...
  },
  {
    ...
    localAngle:
      "Mandi sits at the heart of Himachal's road and rail corridor. Plantation on Mandi district farmer land reduces dust, stabilises slopes along the Mandi-Manali highway, and supports rural farming families.",
  ...
  },
  {
    ...
    localAngle:
      "Solan houses a dense cluster of pharma and FMCG units that need credible carbon offset and CSR documentation. Local plantation through Himsols gives Solan-based companies a verified, traceable offset right at their doorstep.",
  ...
  },
  {
    ...
    localAngle:
      "Dalhousie's iconic deodar belt is vulnerable to fire and unregulated tourism. Planting in Chamba district villages around Banikhet and Bakloh extends the deodar corridor and supports remote tribal communities.",
  ...
  },
  {
    ...
    localAngle:
      "Palampur's tea-growing belt sits below the Dhauladhar range and depends on consistent rainfall and healthy upper catchments. Plantation on Palampur farmer land protects tea-growing microclimates and farmer income.",
  ...
  },
  {
    ...
    localAngle:
      "Kasauli's chir pine belt is highly fire-prone in summer. Mixed-species plantation in surrounding Solan villages reduces monoculture risk and builds long-term forest resilience.",
  ...
  },
  {
    ...
    localAngle:
      "Chamba district has some of Himachal's most remote villages and highest poverty rates. Plantation here doubles as climate action and direct rural livelihood support.",
  ...
  },
  {
    ...
    localAngle:
      "Hamirpur's lower-altitude farmland is ideal for agroforestry species that yield fruit, fodder and fuelwood alongside carbon. Himsols' Hamirpur plantation supports small farmers transitioning to multi-layer cropping.",
  ...
  },
  {
    ...
    localAngle:
      "Una's flat industrial belt has high air-pollution load and limited tree cover. Plantation on Una farmer land is one of the highest-ROI air-quality interventions in Himachal.",
  ...
  },
  {
    ...
    localAngle:
      "Bilaspur's reservoir catchment urgently needs upper-slope greening to prevent siltation. Plantation on Bilaspur farmer land protects water security for downstream Punjab and Himachal.",
  ...
  },
  {
    ...
    localAngle:
      "Kangra valley is Himachal's largest agricultural district. Plantation across Kangra blends climate action with agri-resilience for thousands of small farming households.",
  ...
  },
  {
    ...
    localAngle:
      "Kinnaur faces escalating glacial-lake and landslide risk. High-altitude agroforestry plantation here directly stabilises slopes and protects apple farmer income.",
  ...
  },
  {
    ...
    localAngle:
      "Sirmaur's mid-hills support ginger and turmeric farmers whose land is ideal for shade-tree agroforestry. Plantation here doubles as soil-cover and shade for cash crops.",
  ...
  },
  {
    ...
    localAngle:
      "Nahan's Shivalik foothills are highly erosion-prone. Native tree plantation on surrounding farmer land is the cheapest, most durable soil-stabilisation intervention available.",
  ...
  },
  {
    ...
    localAngle:
      "Spiti is a high-altitude cold desert where every tree counts. Himsols supports community plantation of sea buckthorn and hardy willows that protect Spiti's villages from cold winds and erosion.",
  ...
  },
  {
    ...
    localAngle:
      "Kufri's tourism load far exceeds its ecological carrying capacity. Plantation in surrounding villages buffers the area's deodar belt from tourist-related stress.",
  ...
  },
  {
    ...
    localAngle:
      "McLeod Ganj's hillsides are visibly degraded from cafés, guesthouses and trekking traffic. Plantation on adjacent Kangra farmer land helps rebalance the local ecosystem.",
