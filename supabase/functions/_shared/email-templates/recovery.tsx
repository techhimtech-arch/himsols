...
export const RecoveryEmail = ({
  ...
  <Html lang="hi" dir="ltr">
    <Head />
    <Preview>🔑 Himsols - Password Reset करें</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Heading style={h1}>Password Reset करें 🔒</Heading>
        <Text style={text}>
          आपने अपना password reset करने की request की है। नया password set करने के लिए नीचे दिए button पर click करें:
        </Text>
