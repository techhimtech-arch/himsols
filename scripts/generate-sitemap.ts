...
const staticEntries: SitemapEntry[] = [
  ...
  { path: "/csr/guide-to-csr-plantation-india", changefreq: "monthly", priority: "0.85" },
  { path: "/green-quiz", changefreq: "monthly", priority: "0.6" },
  { path: "/learn", changefreq: "weekly", priority: "0.8" },
  { path: "/learn/lessons", changefreq: "weekly", priority: "0.6" },
  { path: "/learn/daily", changefreq: "weekly", priority: "0.5" },
  { path: "/learn/videos", changefreq: "weekly", priority: "0.5" },
  { path: "/learn/why-trees-matter", changefreq: "monthly", priority: "0.8" },
  { path: "/learn/how-we-plant", changefreq: "monthly", priority: "0.8" },
  { path: "/learn/himachal-jungles", changefreq: "monthly", priority: "0.8" },
  { path: "/learn/forest-fires", changefreq: "monthly", priority: "0.8" },
  { path: "/learn/sustainability-habits", changefreq: "monthly", priority: "0.8" },
];
